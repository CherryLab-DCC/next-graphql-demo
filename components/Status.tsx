...
export const statusToClassElement = (status: string) =>
...
const accessionedStatuses = {
  external: ["released", "revoked"],
  consortium: ["in progress"],
  administrator: ["deleted", "replaced"],
};

const datasetStatuses = {
  external: ["released", "archived", "revoked"],
  consortium: ["in progress", "submitted"],
  administrator: ["deleted", "replaced"],
};

const sharedStatuses = {
  external: ["current"],
  administrator: ["deleted", "disabled"],
};
...
const defaultObjectStatuses: { [key: string]: { [key: string]: string[] } } = {
  AccessKey: {
    external: ["current"],
    administrator: ["deleted"],
  },
  ...
  AntibodyCharacterization: {
    ...
    consortium: ["in progress", "pending dcc review"],
    administrator: ["deleted"],
  },
  ...
  Cart: {
    external: ["released", "listed", "unlisted", "revoked"],
    administrator: ["deleted"],
  },
  ...
  File: {
    external: ["released", "archived", "revoked"],
    unprivileged: [],
    consortium: ["in progress", "uploading", "upload failed", "content error"],
    administrator: ["deleted", "replaced"],
  },
...
const iconDefinitions = {
  archived: (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
      <path d="M8,4a8,8,0,0,0-8,8H16A8,8,0,0,0,8,4Z" />
    </svg>
  ),
  completed: (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
      <path d="M8,0a8,8,0,1,0,8,8A8,8,0,0,0,8,0ZM8,14.17A6.17,6.17,0,1,1,14.17,8,6.17,6.17,0,0,1,8,14.17ZM8,3.75A4.25,4.25,0,1,0,12.25,8,4.25,4.25,0,0,0,8,3.75Z" />
    </svg>
  ),
  deleted: (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
      <polygon points="8 0 16 13 0 13 8 0" transform="translate(0 1.5)" />
    </svg>
  ),
  disabled: (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
      <path d="M14.62,3.5l-1.1,1.1a6.44,6.44,0,0,1,0,6.8l1.1,1.1a8,8,0,0,0,0-9ZM1.38,3.5a8,8,0,0,0,0,9l1.1-1.1a6.44,6.44,0,0,1,0-6.8ZM3.5,1.38l1.1,1.1a6.44,6.44,0,0,1,6.8,0l1.1-1.1a8,8,0,0,0-9,0ZM8,14.49a6.45,6.45,0,0,1-3.4-1l-1.1,1.1a8,8,0,0,0,9,0l-1.1-1.1A6.45,6.45,0,0,1,8,14.49Z" />
    </svg>
  ),
  empty: (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
      <path d="M8,0a8,8,0,1,0,8,8A8,8,0,0,0,8,0ZM8,14.17A6.17,6.17,0,1,1,14.17,8,6.17,6.17,0,0,1,8,14.17Z" />
    </svg>
  ),
  error: (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
      <path d="M8,0a8,8,0,1,0,8,8A8,8,0,0,0,8,0ZM8,14.17A6.17,6.17,0,1,1,14.17,8,6.17,6.17,0,0,1,8,14.17Zm2.24-9.86L8,6.55,5.76,4.31,4.31,5.76,6.55,8,4.31,10.24l1.45,1.45L8,9.45l2.24,2.24,1.45-1.45L9.45,8l2.24-2.24Z" />
    </svg>
  ),
  exempt: (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
      <rect
        ...
        width="15.09"
        height="7.54"
        transform="translate(19.32 8) rotate(135)"
      />
    </svg>
  ),
  inProgress: (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
      <path d="M8,16A8,8,0,1,0,0,8,8,8,0,0,0,8,16ZM8,1.83A6.17,6.17,0,0,1,8,14.17Z" />
    </svg>
  ),
  notCompliant: (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
      <rect width="16" height="8" transform="translate(0 4)" />
    </svg>
  ),
  notReviewed: (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
      <rect width="16" height="16" rx="3.92" ry="3.92" />
    </svg>
  ),
  notSubmitted: (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
      <rect width="8" height="16" transform="translate(4 0)" />
    </svg>
  ),
  released: (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
  ...
  replaced: (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
      <path d="M8,5.88A2.13,2.13,0,1,0,10.12,8,2.12,2.12,0,0,0,8,5.88ZM8,0a8,8,0,1,0,8,8A8,8,0,0,0,8,0ZM8,12.53A4.53,4.53,0,1,1,12.53,8,4.53,4.53,0,0,1,8,12.53Z" />
    </svg>
  ),
  review: (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
      <path d="M16,8a8,8,0,1,0-8,8A8,8,0,0,0,16,8ZM1.83,8A6.17,6.17,0,0,1,14.17,8Z" />
    </svg>
  ),
  submitted: (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
      <path d="M8,0a8,8,0,1,0,8,8A8,8,0,0,0,8,0ZM8,12.53A4.53,4.53,0,1,1,12.53,8,4.53,4.53,0,0,1,8,12.53Z" />
    </svg>
  ),
  waiting: (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
      <path d="M8,0a8,8,0,1,0,8,8A8,8,0,0,0,8,0ZM8,14.17A6.17,6.17,0,1,1,14.17,8,6.17,6.17,0,0,1,8,14.17ZM9.5,6.5v-3h-3v3h-3v3h3v3h3v-3h3v-3Z" />
    </svg>
  ),
  unusuable: (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
      <path d="M8,0a8,8,0,1,0,8,8A8,8,0,0,0,8,0ZM8,14.17A6.17,6.17,0,1,1,14.17,8,6.17,6.17,0,0,1,8,14.17ZM3.5,6.5v3h9v-3Z" />
    </svg>
  ),
  uploading: (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
      <path d="M0,0V16H16V0ZM14.17,14.17H8V1.83h6.17Z" />
    </svg>
  ),
  listed: (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
  ...
  unlisted: (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
      <path d="M8,4.6L11.4,8L8,11.4L4.6,8L8,4.6 M8,0.3L0.3,8L8,15.7L15.7,8L8,0.3L8,0.3z" />
    </svg>
  ),
};
 ...
 */
 export const sessionToAccessLevel = (session?: any, sessionProperties?: any) => {
  const loggedIn = !!(session && session["auth.userid"]);
  const administrativeUser =
    loggedIn && !!(sessionProperties && sessionProperties.admin);
  let accessLevel = "";
  if (!loggedIn) {
    ...
    sessionProperties.user.lab &&
    sessionProperties.user.submits_for.length > 0
  ) {
...
export const getObjectStatuses = (
  item: string | { _type: string[] },
  accessLevel = "external",
  objectStatuses = defaultObjectStatuses
) => {
  // Go down the @type list for the object until a matching block is found in `objectStatuses`.
  const objectType =
    typeof item === "string"
      ? item
      : item._type.find((type) => objectStatuses[type]) ?? 'Item';
  ...
  if (objectType && objectStatuses[objectType]) {
    ...
    const allowedAccessLevels = objectStatusLevels.slice(
      0,
      objectStatusLevels.indexOf(accessLevel) + 1
    );
    if (allowedAccessLevels.length > 0) {
      return Object.keys(objectStatuses[objectType] ?? []).reduce(
        (combinedStatuses, level) =>
          allowedAccessLevels.indexOf(level) > -1
            ? combinedStatuses.concat(objectStatuses?.[objectType]?.[level] ?? [])
            : combinedStatuses,
        [] as string[]
      );
    }
...
const Status = ({
  ...
  badgeSize: "small" | "standard" | "large";
  title: string;
  css: string;
  noLabel: boolean;
  noIcon: boolean;
  ...
  const classElement = statusToClassElement(status);

  return (
    <div className={`${inline ? "status--inline" : ""}${css ? ` ${css}` : ""}`}>
      <div
        className={`status status--${badgeSize} status--${classElement}`}
        {...(title ? { title } : {})}
      >
        {!noIcon ? (
          <div
            className={`status__icon${!noLabel ? " status__icon--spacer" : ""}`}
          >
            {statusIcons[classElement] || statusIcons["released"]}
          </div>
        ) : null}
